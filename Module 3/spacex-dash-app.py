...
# create dropdown options from the unique launch sites
...
def update_pie_chart(selected_site):
    if selected_site == 'ALL':
        # All sites selected: show total success launches by site
        fig = px.pie(
            spacex_df,
            names='Launch Site',
            values='class',
...
def update_scatter_chart(selected_site , payload_range):
      ...
      if selected_site == 'ALL':
        ...
        site_df = filtered_payload_df[filtered_payload_df['Launch Site'] == selected_site]
        fig = px.scatter(
            site_df,
            x='Payload Mass (kg)',
            y='class',
